  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="px-4 py-6 text-center text-xs text-brand-gray border-t border-brand-border">
        <Link href="/" className="hover:text-brand-green">Vysi</Link> · <Link href="/privacy" className="hover:text-brand-green">{locale === 'it' ? 'Privacy Policy' : locale === 'es' ? 'Política de Privacidad' : 'Privacy Policy'}</Link>
      </footer>
    </div>
  )
}
